...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\gpphone on
     Windows, /home/user/dev/gpphone on Linux) in a file named
     gpphone@mozilla.messaging.inc. and copy that file to
